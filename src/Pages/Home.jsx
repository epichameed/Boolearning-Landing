...
const Home = () => {
  return (
    <div className="flex flex-col w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 flex flex-col">
              ...
              <p className="text-base sm:text-lg text-white font-poppins mb-6">
                ...
                our passionate and friendly teachers who's been in your shoes
      ...
      {/* Adapted for Different Learning Styles Section */}
      <div className="bg-green_1 w-full py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="w-full lg:w-1/2">
      ...
      <div className="bg-green_3 w-full py-12 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex md:flex-row flex-col">
          <div className="md:w-1/2 w-full">
            ...
            <div className="flex md:gap-4 gap-2 font-rambla font-semibold mt-8 md:text-base text-sm text-center">
              <div className="bg-white text-green_3 rounded-lg md:px-4 px-2 py-1">
                Learning Plans
              </div>
              <div className="bg-white text-green_3 rounded-lg md:px-4 px-2 py-1">
                Real-life scenario
            ...
            <div className="flex gap-4 font-rambla mt-5">
              <div className="bg-green_2 text-white md:px-4 px-2 py-1 rounded-lg">
                Learning Plans
              </div>
              <div className="bg-green_2 text-white md:px-4 px-2 py-1 rounded-lg">
                Real-life scenario
          ...
          <div className="md:w-1/2 w-full flex justify-center">
            <img
              src="/learning-paths.png"
              alt=""
              className="lg:w-96 md:w-full w-64"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-green_1 w-full py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-rambla font-semibold text-green_3 md:my-12 my-5 md:text-xl text-lg">
            ...
            questions-let's make learning English and French fun and effortless
            together!
          </p>
