...
const Navigation = () => {
  return (
    <nav className="hidden md:flex items-center space-x-6">
      ...
      <Link to="/demo" className="text-black_1 hover:text-green_ font-bold  font-poppins">Demo</Link>
      ...
      <Link to="/about" className="text-black_1 hover:text-green_ font-bold  font-poppins">About</Link>
