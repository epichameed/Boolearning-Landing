...
const Navigation = () => {
  return (
    <nav className="hidden md:flex items-center space-x-6">
      <Link to="/app" className="text-black_1 hover:text-green_2 font-bold font-poppins">Home</Link>
      ...
      <Link to="/app/login" className="text-black_1 hover:text-green_2 font-bold font-poppins">Login</Link>
