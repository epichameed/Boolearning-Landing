...
const Footer = () => {
  return (
    <footer className="bg-green_1 text-green_3 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm">Email: info@boolearning.com</p>
          ...
          <div className="w-full md:w-1/4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-green_3 hover:text-green_2">
        ...
        <div className="mt-8 border-t border-green_2 pt-8 text-sm text-center">
          <p>
            &copy; {new Date().getFullYear()} Boo Learning. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
